...
var (
	addr          = flag.String("addr", "localhost:11250", "server address")
	foreignAddr   = flag.String("foreignAddr", "localhost:11250", "server address")
	etcdAddr      = flag.String("etcdAddr", "localhost:2479", "etcd address")
	basePath      = flag.String("base", "/rpcx", "prefix path")
	wsAddr        = flag.String("wsAddr", "localhost:11280", "server address")
	wsForeignAddr = flag.String("wsForeignAddr", "localhost:11280", "server address")
...
func main() {
	...
	//游戏服务器的客户端
	args.RpcxClient = &frame.RpcxClient{frame.Discovery_Etcd, frame.Rpcx{EtcdAddr: etcdAddr, BasePath: basePath}, "DoudizhuS", frame.BIDIRECTIONAL}
	//redis
