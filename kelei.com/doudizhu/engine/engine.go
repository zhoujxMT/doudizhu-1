...
//获得玩家积分
func (this *Engine) GetVideoIntegral(args *rpcs.Args) *rpcs.Reply {
	res := GetVideoIntegral(this.getArgs(args))
	return &rpcs.Reply{res, common.SC_OK}
}

//获取比赛信息
func (this *Engine) GetMatchTopInfo(args *rpcs.Args) *rpcs.Reply {
	res := GetMatchTopInfo(this.getArgs(args))
	return &rpcs.Reply{res, common.SC_OK}
}

//获取本局任务
func (this *Engine) GetCouncilTask(args *rpcs.Args) *rpcs.Reply {
	res := GetCouncilTask(this.getArgs(args))
	return &rpcs.Reply{res, common.SC_OK}
}

//明牌
func (this *Engine) OpenHand(args *rpcs.Args) *rpcs.Reply {
	res := OpenHand(this.getArgs(args))
	return &rpcs.Reply{res, common.SC_OK}
}

//不明牌
func (this *Engine) NoOpenHand(args *rpcs.Args) *rpcs.Reply {
	res := NoOpenHand(this.getArgs(args))
	return &rpcs.Reply{res, common.SC_OK}
}

//叫地主
func (this *Engine) CallLandlord(args *rpcs.Args) *rpcs.Reply {
	res := CallLandlord(this.getArgs(args))
	return &rpcs.Reply{res, common.SC_OK}
}

//不叫地主
func (this *Engine) NoCallLandlord(args *rpcs.Args) *rpcs.Reply {
	res := NoCallLandlord(this.getArgs(args))
	return &rpcs.Reply{res, common.SC_OK}
}

//抢地主
func (this *Engine) RushLandlord(args *rpcs.Args) *rpcs.Reply {
	res := RushLandlord(this.getArgs(args))
	return &rpcs.Reply{res, common.SC_OK}
}

//不抢地主
func (this *Engine) NoRushLandlord(args *rpcs.Args) *rpcs.Reply {
	res := NoRushLandlord(this.getArgs(args))
	return &rpcs.Reply{res, common.SC_OK}
}

//加倍
func (this *Engine) Double(args *rpcs.Args) *rpcs.Reply {
	res := Double(this.getArgs(args))
	return &rpcs.Reply{res, common.SC_OK}
}

//不加倍
func (this *Engine) NoDouble(args *rpcs.Args) *rpcs.Reply {
	res := NoDouble(this.getArgs(args))
	return &rpcs.Reply{res, common.SC_OK}
}

//玩家操作
func (this *Engine) UserHandle(args *rpcs.Args) *rpcs.Reply {
	res := UserHandle(this.getArgs(args))
	return &rpcs.Reply{res, common.SC_OK}
}
...
//获取裁判后台数据
func (this *Engine) GetJudgmentBgInfo(args *rpcs.Args) *rpcs.Reply {
	res := GetJudgmentBgInfo(this.getArgs(args))
	return &rpcs.Reply{res, common.SC_OK}
}

//修改分值根据uid
func (this *Engine) UpdateVideoIntegral(args *rpcs.Args) *rpcs.Reply {
	res := UpdateVideoIntegral(this.getArgs(args))
	return &rpcs.Reply{res, common.SC_OK}
}

//修改当前局数
func (this *Engine) UpdateInning(args *rpcs.Args) *rpcs.Reply {
	res := UpdateInning(this.getArgs(args))
	return &rpcs.Reply{res, common.SC_OK}
}

//修改总局数
func (this *Engine) UpdateInnings(args *rpcs.Args) *rpcs.Reply {
	res := UpdateInnings(this.getArgs(args))
	return &rpcs.Reply{res, common.SC_OK}
}

//修改常规赛局数
func (this *Engine) UpdateInningRegular(args *rpcs.Args) *rpcs.Reply {
	res := UpdateInningRegular(this.getArgs(args))
	return &rpcs.Reply{res, common.SC_OK}
}
