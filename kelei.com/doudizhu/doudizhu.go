...
import (
	...
	"kelei.com/doudizhu/cmds"
	eng "kelei.com/doudizhu/engine"
	"kelei.com/doudizhu/rpcs"
...
var (
	addr        = flag.String("addr", "localhost:11150", "server address")
	foreignAddr = flag.String("foreignAddr", "localhost:11150", "server address")
	etcdAddr    = flag.String("etcdAddr", "localhost:2479", "etcd address")
	basePath    = flag.String("base", "/rpcx", "prefix path")
	gameDB      = flag.String("gameDB", "game,root,111111,127.0.0.1:3306,doudizhu_game", "")
	memberDB    = flag.String("memberDB", "member,root,111111,127.0.0.1:3306,doudizhu_nmmember", "")
	gameRedis   = flag.String("gameRedis", "localhost:11100", "")
	memberRedis = flag.String("memberRedis", "localhost:11400", "")
)
...
func main() {
	...
	//启动服务
	args := frame.Args{}
	args.ServerName = "doudizhu"
	args.Commands = cmds.GetCmds()
	//gate的服务端
	args.RpcxServer = &frame.RpcxServer{frame.Discovery_Etcd, frame.Rpcx{addr, foreignAddr, etcdAddr, basePath}, []interface{}{new(rpcs.DoudizhuS)}}
	//redis
...
func test() {
	...
	//	user.GetLeastCards()
	//	room := eng.Room{}
	//	room.SetCardMode(eng.CARDMODE_NOWASH)
	//	room.GenerateCards()
	//	user := eng.User{}
	//	user.Excel()
}
