...
var (
	serversAddr = flag.String("serversAddr", "localhost:11150", "server address")
...
func main() {
	...
	//游戏服务器的客户端
	args.RpcxClient = &frame.RpcxClient{frame.Discovery_MultipleServers, frame.Rpcx{Addr: serversAddr}, "DoudizhuS", frame.UNIDIRECTIONAL}
	//mysql
